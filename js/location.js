...
var branch_btns = document.querySelectorAll(".branch li"); //지점 보기버튼 선택자

//처음 로딩완료시 출력될 지도의 경도, 위도
//1. 구글맵에서 검색해서 경도, 위도값 구함(위치값이 정밀하지 못함)
//2. 카카오맵 api에서 클릭으로 마커표시 샘플코드 (위의 위치값을 적용)
//3. 해당위치에서 우리가 원하는 위치를 정밀하게 마커로 찍어서 표시 (위도, 경도값) 구함
var options = { 
	center: new kakao.maps.LatLng(37.506091,126.749776317), 
	level: 3 
};
...
var markerOptions = [
    {
        title:"본점", 
        latlng: new kakao.maps.LatLng(37.506091,126.749776317),
        imgSrc : 'img/marker1.png', 
        imgSize: new kakao.maps.Size(232,99),
        imgPos : { offset: new kakao.maps.Point(116,99)}, //116,09
        button: branch_btns[0]
    },
    {
        title:"지점1", 
        latlng: new kakao.maps.LatLng(37.484085,126.7806143),
